 ...
 * @param {Object} contracts - The Urbit contracts object.
 * @param {Number} tokenId - Ship token.
 * @return {Bool} true if ship is active, false otherwise.
 */
 ...
 * @param {Object} contracts - The Urbit contracts object.
 * @param {Number} tokenId - Ship token.
 * @return {String} The transfer proxy's address.
 */
 ...
 * @return {Bool} true if 'operator' is an operator for 'owner'.
 */
 ...
 * @return {Bool} True if ship can escape, false otherwise.
 */
